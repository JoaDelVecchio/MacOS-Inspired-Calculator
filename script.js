    ...
    Buttons.forEach((button) => {
        button.addEventListener("click", () => {
            ...
            if (numbers.includes(button.textContent)) {
                if (operator == "") {
                    if (result !== "") {
                        // Reset num1 and result to start a new operation after displaying a result
            ...
            // Handle operator button clicks
                ...
                if (button.textContent != "=") {
                    ...
                    result = operate(operator || lastOperator, parseFloat(num1), parseFloat(num2));
                    displayValue.textContent = result;
                    num1 = result.toString();
            ...
            // Handle functionality button clicks
                ...
                switch (button.textContent) {
                    case "R":
                        // Remove last character to allow correcting mistakes
                        if (operator === "") {
                            num1 = num1.slice(0, -1);
                        } else if (num2 !== "") {
                            num2 = num2.slice(0, -1);
